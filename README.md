...
#### `point` block
```ruby
point(name:, label:, type:, icon:, tags:, parent: nil)
```
+ name
  + Must not start with a number.
  + Allowed characters: A-Z, a-z, 0-9, _ (underscores).
...
# Group livingroom "Living Room" <room> (house) ["Location"]
# Group livingroom_sensor "livingroom_Sensor" <sensor> (livingroom) ["Equipment"]
# Number livingroom_temperature "livingroom Temperature" <temperature> (livingroom_sensor) ["Temperature"]
# Group bedroom "Bed Room" <room> (house) ["Location"]
# Group bedroom_sensor "bedroom_Sensor" <sensor> (bedroom) ["Equipment"]
# Number bedroom_temperature "bedroom Temperature" <temperature> (bedroom_sensor) ["Temperature"]
# Group kitchen "Kitchen" <room> (house) ["Location"]
# Group kitchen_sensor "kitchen_Sensor" <sensor> (kitchen) ["Equipment"]
...
input_code = <<~RUBY
  location(name: "house", label: "House", icon: "house") do
    location(name: "livingroom", label: "Living Room", icon: "room") do
